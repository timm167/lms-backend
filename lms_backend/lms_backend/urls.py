...
from core.views import MyLoginView, MySignupView
from drf_yasg.views import get_schema_view
from drf_yasg import openapi
from core.generate import generate_data, delete_all_except_superusers
...
urlpatterns = [
    ...
    # Generate data
    path('generate/', generate_data, name='generate-data'),

    # Delete all data except superusers
    path('delete/', delete_all_except_superusers, name='delete-data'),
    ...
    path('accounts/signup/', MySignupView.as_view(), name='logout'),
